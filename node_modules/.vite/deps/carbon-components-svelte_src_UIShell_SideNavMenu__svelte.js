...
var file = "node_modules/carbon-components-svelte/src/UIShell/SideNavMenu.svelte";
...
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file, 35, 6, 797);
    },
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file, 42, 4, 1019);
      set_attributes(button, button_data);
      toggle_class(button, "bx--side-nav__submenu", true);
      add_location(button, file, 23, 2, 543);
      ...
      add_location(ul, file, 51, 2, 1291);
...
var SideNavMenu = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
    init(this, options, instance, create_fragment, safe_not_equal, { expanded: 0, text: 2, icon: 3, ref: 1 });
...
export {
  SideNavMenu_default as default
};
//# sourceMappingURL=carbon-components-svelte_src_UIShell_SideNavMenu__svelte.js.map
