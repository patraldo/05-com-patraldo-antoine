...
var file = "node_modules/carbon-components-svelte/src/UIShell/SideNavMenuItem.svelte";
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file, 29, 4, 587);
      set_attributes(a, a_data);
      toggle_class(a, "bx--side-nav__link", true);
      add_location(a, file, 21, 2, 411);
      toggle_class(li, "bx--side-nav__menu-item", true);
      add_location(li, file, 20, 0, 365);
    },
    m: function mount(target, anchor) {
...
var SideNavMenuItem = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
    init(this, options, instance, create_fragment, safe_not_equal, { isSelected: 1, href: 2, text: 3, ref: 0 });
...
export {
  SideNavMenuItem_default as default
};
//# sourceMappingURL=carbon-components-svelte_src_UIShell_SideNavMenuItem__svelte.js.map
